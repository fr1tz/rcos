...
func _create_pad():
	var pad = load("res://virtual_gamepads/multipad/multipad_control.tscn").instance()
	rlib.set_meta_recursive(pad, "widget_host_api", get_meta("widget_host_api"))
	rlib.set_meta_recursive(pad, "io_ports_path_prefix", get_meta("io_ports_path_prefix"))
	return pad
