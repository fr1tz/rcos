...
func _create_widget_factories():
	var info_files = rlib.find_files("res://modules/ffa_widgets/", "*.info")
	for info_file in info_files:
		...
		if err != OK:
			...
			continue
		if !config_file.has_section("widget"):
			continue
		...
		var factory = rlib.instance_scene("res://modules/ffa_widgets/widget_factory.tscn")
		add_child(factory)
